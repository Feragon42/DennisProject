  <footer>
    ...
    <!--********************Importar todos los links de scripts**************************************-->
    <!--Import JQuery-->
    <script type='text/javascript' src='public/scripts/jquery.min.js'></script>
    <!--Import Bootstrap JS--> 
    <script type='text/javascript' src='public/scripts/bootstrap.min.js'></script>
    <!--Import PrintThis-->
    <script type='text/javascript' src='public/scripts/printThis.js'></script>
    <!--Custom js documents-->
    <script type='text/javascript' src='public/scripts/styleLogic.js'></script>
    <script type='text/javascript' src='public/scripts/adminSLogicUsers.js'></script>
